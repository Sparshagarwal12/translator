        ...
        child: MaterialButton(
          onPressed: () async {
            ...
            for (int i = 0; i < members; i++) {
              if (declaration.editor[i].text == "" ||
                  declaration.editor[i].text == null ||
                  declaration.adhharEditor[i].text == "" ||
                  declaration.adhharEditor[i].text == null) {
                error = true;
              }
            }
            ...
            if (error == false) {
              for (int i = 0; i < members; i++) {
                if (declaration.symptoms[i]["attendJamat"] == true ||
                    declaration.symptoms[i]["metJamatis"] == true ||
                    declaration.symptoms[i]["metSomeoneAbroad"] ||
                    declaration.symptoms[i]["outbreakPlaceVisit"]) {
                  declaration.haveSymptoms[i] = true;
                } else if (declaration.symptoms[i]["dizziness"] == true ||
                    declaration.symptoms[i]["cough"] == true &&
                        declaration.symptoms[i]["nose"] == true &&
                        declaration.symptoms[i]["fever"] == true) {
                  declaration.haveSymptoms[i] = true;
                } else if (declaration.symptoms[i]["cough"] == true &&
                    declaration.symptoms[i]["nose"] == true &&
                    declaration.symptoms[i]["fever"] == true &&
                    declaration.symptoms[i]["throatchest"] == true) {
                  declaration.haveSymptoms[i] = true;
                } else if (declaration.symptoms[i]["cough"] == true &&
                    declaration.symptoms[i]["nose"] == true &&
                    (declaration.symptoms[i]["pronounciation"] == true ||
                        declaration.symptoms[i]["breathing"] == true ||
                        declaration.symptoms[i]["diarrhea"] == true)) {
                  declaration.haveSymptoms[i] = true;
                } else {
                  declaration.haveSymptoms[i] = false;
                }
                if (members != 1) {
                  Map content = await declaration
                      .geoCoding(declaration.addressEditor[i].text);
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    ...
                    new Radio(
                        activeColor: Colors.black,
                        value: true,
                        groupValue: declaration.symptoms[i]
                            ["outbreakPlaceVisit"],
                        onChanged: (value) {
                          setState(() {
                            declaration.symptoms[i]["outbreakPlaceVisit"] =
      ...
      children: <Widget>[
          ...
          children: <Widget>[
            ...
            Container(
              ...
              child: DropdownButton(
                ...
                items: declaration.districtList[id].map((location) {
                  return DropdownMenuItem(
                    child: new Text(location,
                        style: TextStyle(color: Colors.black)),
                    value: location,
        ...
        Container(
          ...
          child: DropdownButton(
            ...
            items: declaration.ageGroupList.map((location) {
              return DropdownMenuItem(
                child:
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  new Radio(
                      activeColor: Colors.black,
                      value: true,
                      groupValue: declaration.haveTravelled[index],
                      onChanged: (value) {
                        setState(() {
                          declaration.haveTravelled[index] = value;
                        });
                      }),
                  Text("No"),
                  new Radio(
    ...
    return Scaffold(
      floatingActionButton: Container(
        ...
        child: IconButton(
            ...
            onPressed: () {
              tempMembers++;
              scroll.animateTo(MediaQuery.of(context).size.width * tempMembers,
