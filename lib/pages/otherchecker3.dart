...
class otherchecker3 extends StatefulWidget {
  @override
  _otherchecker3 createState() => _otherchecker3();
}
                          ...
                          child: Container(
                            ...
                            child: ListView(
                              children: <Widget>[
                                Center(
                                  child: Text(
                                    "क्या उसके पास निम्न जीवन-धमकी के कोई लक्षण हैं?",
...
class selfmajorchecker extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: majorotherchecker());
  }
}

class selfwarn extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text("कोरोना के खिलाफ भारत की लड़ाई")),
